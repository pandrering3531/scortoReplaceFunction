...
namespace STPC.DynamicForms.Core
{
    class DynamicFormModelBinder : IModelBinder
    {
        public object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            if (form == null && !string.IsNullOrEmpty(postedForm[MagicStrings.SerializedForm]))
            {
                form = SerializationUtility.Deserialize<Form>(postedForm[MagicStrings.SerializedForm]);
            }
