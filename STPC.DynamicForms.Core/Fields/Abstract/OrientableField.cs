...
namespace STPC.DynamicForms.Core.Fields
{
    ...
    public abstract class OrientableField : ListField
    {
        ...
        protected string _inputLabelClass = Constants.OF_inputLabelClass;
        protected string _verticalClass = Constants.OF_verticalClass;
        protected string _horizontalClass = Constants.OF_horizontalClass;
        protected string _listClass = Constants.OF_listClass;
