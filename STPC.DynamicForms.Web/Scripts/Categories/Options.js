    ...
    $("#NewOptionForm").dialog({
        ...
        buttons: {
            "Crear": function () {
                ...
                if (bValid) {
                    $.post("/Categories/AddOption", { OptionKey: Key.val(), OptionValue: Value.val(), CategoryName: $("#CategoriesList").val(), idOptionParent: $("#ddlDependencyOption").val() }, function (data) {
                        if (data.Success == true) {
