...
namespace STPC.DynamicForms.Core.Fields
{
    ...
    public abstract class InputField : Field
    {
        ...
        protected string _requiredMessage = Constants.IF_requiredMessage;
        protected string _promptClass = Constants.IF_promptClass;
        protected string _errorClass = Constants.IF_errorClass;
        ...
        protected override string BuildDefaultTemplate()
        {
            ...
            wrapper.AddCssClass(Constants.IF_CSSClass);
